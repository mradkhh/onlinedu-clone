import { Drawer, Select, Progress } from 'antd';
              ...
              <div className="create-course__content-info">
                ...
                <form action="" className='form'>
                  ...
                  <Select defaultValue="active" style={{width: '100%'}} >
                    ...
                    <Option value="free">Milliy tillar</Option>
                  </Select>
                <div className="form-footer">
                  <button data-type='gray'>Архивировать</button>
                  <Link to='/dashboard/create/step2' data-type='primary'>Следущий Этап</Link>
                </div>
                </form>
              </div>
              <div className="create-course__content-card">
              <Progress strokeWidth={8} strokeColor="#26CAAC" type="circle" percent={33} width={130} format={() => '1 этап'}/>
